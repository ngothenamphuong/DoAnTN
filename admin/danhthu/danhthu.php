...
<div class="container-fluid">
	<div class=" alert alert-primary">
	  <h4 class="page-title">
	    ...
	    </span> ADMIN - NHAN PHUONG &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Doanh Thu</h4>
	</div><br>
	<div  class="row">
		<form class="col-xl-3 col-md-6 mb-4" action="danhthu/xuly.php" method="POST" accept-charset="utf-8">
			<div class="card border-left-primary shadow py-2">
                <div class="card-body row">
                	<select name="nam" class="browser-default custom-select " style="width: 100px; margin-top: 10px;">
					<?php
					...
					<button class="btn btn-primary btn-sm" name="xem">Xem</button>
                </div>
            </div>
		</form>
		...
		<form class="col-xl-6 col-md-6 mb-4" action="?action=danhthu" method="POST" accept-charset="utf-8">
			<div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body row">
